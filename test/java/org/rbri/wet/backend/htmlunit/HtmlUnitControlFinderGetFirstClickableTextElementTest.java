...
public class HtmlUnitControlFinderGetFirstClickableTextElementTest extends TestCase {
  ...
  public void testGetFirstClickableTextElement_ById() throws IOException {
    String tmpHtmlCode = "<html><body>" + "<p id='MyId1'>First line</p>" + "<p id='MyId2'>Second line</p>"
        + "</body></html>";
    HtmlPage tmpHtmlPage = PageUtil.constructPage(tmpHtmlCode);
    ...
    assertEquals("[HtmlParagraph 'Second line' (id='MyId2')] found by: BY_ID coverage: 0 distance: 10", tmpFound
  ...
  public void testGetFirstClickableTextElement_ByTextExact() throws IOException {
    String tmpHtmlCode = "<html><body>" + "<p>First line</p>" + "<p>Second line</p>" + "</body></html>";
    HtmlPage tmpHtmlPage = PageUtil.constructPage(tmpHtmlCode);
  ...
  public void testGetFirstClickableTextElement_ByTextPartAfter() throws IOException {
    String tmpHtmlCode = "<html><body>" + "<p>First line</p>" + "<p>Second line</p>" + "<p>Marker</p>"
        + "<p>Last line</p>" + "</body></html>";
    HtmlPage tmpHtmlPage = PageUtil.constructPage(tmpHtmlCode);
  ...
  public void testGetFirstClickableTextElement_ByTextFormated() throws IOException {
    String tmpHtmlCode = "<html><body>" + "<p>First line</p>"
        + "<p>This t<font color='red'>ex</font>t is <b>styled</b>.</p>" + "</body></html>";
    HtmlPage tmpHtmlPage = PageUtil.constructPage(tmpHtmlCode);
  ...
  public void testGetFirstClickableTextElement_ByTextWithBreak() throws IOException {
    String tmpHtmlCode = "<html><body>" + "<p>First<br>line</p>" + "<p>Second<br>line</p>" + "</body></html>";
    HtmlPage tmpHtmlPage = PageUtil.constructPage(tmpHtmlCode);
  ...
  public void testGetFirstClickableTextElement_TableCell() throws IOException {
    String tmpHtmlCode = "<html><body>" + "<table>" + "<tr>" + "<td>cell 1 1</td>" + "<td>cell 1 2</td>" + "</tr>"
        + "<tr>" + "<td>cell 2 1</td>" + "<td>cell 2 2</td>" + "</tr>" + "</table>" + "</body></html>";
    HtmlPage tmpHtmlPage = PageUtil.constructPage(tmpHtmlCode);
  ...
  public void testGetFirstClickableTextElement_TableRow() throws IOException {
    ...
    // TODO
    assertEquals(
        "[Unknown HtmlElement 'class com.gargoylesoftware.htmlunit.html.HtmlTableRow'] found by: BY_TEXT coverage: 0 distance: 0",
        tmpFound.getElementsSorted().get(0).toString());
  }

  public void testGetFirstClickableTextElement_Div() throws IOException {
    String tmpHtmlCode = "<html><body>" + "<div>" + "<h1>Headline</h1>" + "<p>some text</p>" + "</div>"
        + "</body></html>";
    HtmlPage tmpHtmlPage = PageUtil.constructPage(tmpHtmlCode);
