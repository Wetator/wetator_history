 ...
 * @author frank.danek
 */
public class TableMatcherTest3 {
  ...
  public void findInTableNestedCellMultiple() throws IOException {
    String tmpHtmlCode = "<html><body>" //
        ...
        + "          <td>InputSubmit_2</td>" //
        + "          <td id='InputSubmit_2_2'>InputSubmit_2l</td>" //
        + "          <td id='InputSubmit_2_3'><table><tr><td id='InputSubmit_2_3i1'>InputSubmit_2l</td><td id='InputSubmit_2_3i2'>InputSubmit_2l</td></tr></table></td>" //
        + "        </tr>" //
        + "      </tbody>" //
        + "    </table>" //
        + "</body></html>";
  ...
  private List<MatchResult> findInTable(String aHtmlPage, List<SecretString> aSearch) throws IOException {
    ...
    for (Iterator<MatchResult> tmpIterator = tmpRealMatches.iterator(); tmpIterator.hasNext();) {
      MatchResult tmpMatchResult2 = tmpIterator.next();
      boolean tmpFound = false;
      for (MatchResult tmpMatchResult3 : tmpRealMatches) {
